...
module {
  ...
  public type RewardCommandRequest = v2_0_1.RewardCommandRequest;
  ...
  public type RewardCommand = v2_0_1.RewardCommand;

  public type RewardSettings = v2_0_1.RewardSettings;

  public type RewardAction = v2_0_1.RewardAction;
